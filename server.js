...
router.route('/getEventBalance')
    .post(authController.isJWTAuthenticated, receiptController.getEventBalance);

router.route('/getUserBalance')
    .post(authController.isJWTAuthenticated, receiptController.getUserBalance);
